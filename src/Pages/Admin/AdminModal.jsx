...
// https://media-prime-backend.herokuapp.com/admin/editAdmin
export const AdminModal = ({ open, setOpen, id, status }) => {
    ...
    const MakeAdmin = async (e) => {
        ...
        await axios
            .post(`https://media-prime-backend.herokuapp.com/admin/register`, {
                email: emailAddress,
            })
            .then((res) => {
    ...
    const DeleteAdmin = async (e) => {
        ...
        // dispatch(updateAdminAction(emailAddress, status))
        await axios
            .post(`https://media-prime-backend.herokuapp.com/admin/deleteAdmin`, {
                email: emailAddress,
            })
            .then((res) => {
                console.log(res.data)
